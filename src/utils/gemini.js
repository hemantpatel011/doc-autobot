...
export const generateReadmeFromProject = async (projectContent) => {
  ...
  const prompt = `
    ...
    - Badges (npm, Python, GitHub Actions, Docker, Made with doc-autobot(Must), etc)
    - Project name 
    - Project description
    ...
    Ensure the README.md is well-structured, easy to read. Don't give extra text only add short comments in folder Structure.
